...
#define UART6_GPIO_RCC      RCC_AHB1Periph_GPIOG
#define RCC_APBPeriph_UART6 RCC_APB2Periph_USART6
#define UART6_TX_DMA        DMA1_Stream6
...
int stm32_hw_usart_init(void)
{
    ...
    struct serial_configure config4 = RT_SERIAL_CONFIG_4;
    RCC_Configuration();
    GPIO_Configuration();
