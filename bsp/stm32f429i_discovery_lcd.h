...
#define  LCD_PIXEL_HEIGHT   ((uint16_t)800)

#define LCD_FRAME_BUFFER       ((uint32_t)0xD0000000)
#define BUFFER_OFFSET          ((uint32_t) 0xBB800)//((uint32_t)0x50000) //((uint32_t)0x120000)//
/**
...
#define LCD_NCS_GPIO_CLK        RCC_AHB1Periph_GPIOG 
...
/** 
  ...
  */ 
#define LCD_SPI_SCK_PIN               GPIO_Pin_13                     /* PF.07 */
#define LCD_SPI_SCK_GPIO_PORT         GPIOB                          /* GPIOF */
...
#define LCD_SPI_MISO_PIN              GPIO_Pin_2                     /* PF.08 */
#define LCD_SPI_MISO_GPIO_PORT        GPIOC                          /* GPIOF */
...
#define LCD_SPI_MOSI_PIN              GPIO_Pin_3                     /* PF.09 */
#define LCD_SPI_MOSI_GPIO_PORT        GPIOI                          /* GPIOF */
#define LCD_SPI_MOSI_GPIO_CLK         RCC_AHB1Periph_GPIOI  
#define LCD_SPI_MOSI_SOURCE           GPIO_PinSource3
